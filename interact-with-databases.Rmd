...
database** is the most widely used type of database; this is a type of
database in which several tables, consisting of rows and columns (e.g.
data frame), are related to one another.
