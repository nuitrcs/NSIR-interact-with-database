...
what your *Database Management System* (DBMS). DBMS is the software
...
your computer), but in an online server. In these cases, you will often
need to input `host=`, which is the address of the database, `user`, and
`password`.
